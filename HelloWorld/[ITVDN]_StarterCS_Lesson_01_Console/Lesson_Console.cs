...
перед ними оператор “@”.";
        ...
        static void ComparisonOperators() //Операторы сравнения
        {
            /*  Операторы сравнения:
              o равно “==”
              o не равно “!=”
        ...
        #endregion
        #region Lesson 18 Bitwise Operators - Битовые операции
        static void BitwiseComplementOperator() //Оператор побитового отрицания
        {
            // Оператор побитового отрицания, представлен значком ~, который называется «тильда».

            int a = 1;
            int b = ~a;
            // Формула изменения знака числа: ~(+N) + 1 = -N и ~(-N) + 1 = +N
            int c = b + 1;

            Console.WriteLine($"a = {a}, b = {b}, c = {c}");
        }
        static void IntegerConjunction() //Побитовое отрицание коньюкция
        {
            // Целочисленные битовые операторы воспринимают все двоичные единицы как true
            // (истину), а все двоичные нули, воспринимают как false(ложь).

            //  Побитовое отрицание(или побитовое НЕ, или дополнение) – это унарная операция,
            //   действие которой эквивалентно применению логического отрицания к каждому биту
            //   числа, представленного в двоичной форме. 
            ...
            // 0 0 0 0     1 1 1 1 PORT
            // & & & &     & & & & 
            // 1 1 1 1     1 0 1 1 MASK
            // = = = =     = = = = 
            // 0 0 0 0     1 0 1 1 NEW PORT

            // Побитовое И – это бинарная операция, действие которой эквивалентно применению
            //  логического «И» к каждой паре битов, которые стоят на одинаковых позициях в
            //  двоичных представлениях операндов. Другими словами, если оба соответствующих
            //  бита операндов равны 1, результирующий двоичный разряд равен 1; если же хотя бы
            //  один бит из пары равен 0, результирующий двоичный разряд равен 0.
        }
        static void IntegerDisjunction() //Побитовое отрицание дизньюкция
        {
            ...
            // 0 0 0 0    1 0 1 1 PORT
            // | | | |    | | | |
            // 0 0 0 0    0 1 0 0 MASK
            // = = = =    = = = = 
            // 0 0 0 0    1 1 1 1 NEW PORT

            // Побитовое ИЛИ – это бинарная операция, действие которой эквивалентно
            // применению логического «ИЛИ» к каждой паре битов, которые стоят на одинаковых
            // позициях в двоичных представлениях операндов. Другими словами, если оба
            // соответствующих бита операндов равны 0, двоичный разряд результата равен 0; если
            // же хотя бы один бит из пары равен 1, двоичный разряд результата равен 1.
        }
        static void IntegerExclusiveOr() //Побитовое исключающее «ИЛИ»
        {
            ...
            // Побитовое исключающее ИЛИ(или побитовое сложение по модулю два) – это
            // бинарная операция, действие которой эквивалентно применению логического
            // исключающего «ИЛИ» к каждой паре битов, которые стоят на одинаковых позициях в
            // двоичных представлениях операндов. Другими словами, если соответствующие биты
            // операндов различны, то двоичный разряд результата равен 1; если же биты совпадают,
            // то двоичный разряд результата равен 0.
        }
        static void Shift() //Битовые сдвиги
        {
            // Битовые сдвиги — это битовые операции, при которых значения битов копируются в
            // соседние по направлению сдвига. Различают несколько видов сдвигов – логический,
            // арифметический и циклический, в зависимости от обработки крайних битов.

            // Оператор сдвига влево (<<) сдвигает первый операнд влево, в соответствии с
            // количеством бит, заданным вторым операндом. Тип второго операнда должен быть int
            // или тип, имеющий предопределенное неявное числовое преобразование в int.

            // Оператор сдвига вправо(>>) сдвигает первый операнд вправо в соответствии с
            // количеством бит, заданным вторым операндом.
